...
This is a browser-based arcade game designed to be lightweight and runnable on any device.
...
This is a personal project developed using vanilla JavaScript, HTML, and Tailwind CSS (loaded via CDN) to create a self-contained, single-file game application.
